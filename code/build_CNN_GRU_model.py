from tensorflow.keras.layers import Input, Dense, Conv1D, Flatten, MaxPooling1D, Dropout, BatchNormalization, GRU, concatenate
...
def model_1(input_shape):
    ...
    # LSTM
    lstm = GRU(64, input_shape=input_shape, activation='tanh', return_sequences=True)(input_)
    lstm = Dropout(0.3)(lstm)
    lstm = GRU(64, activation='tanh')(lstm)
    lstm = Dropout(0.3)(lstm)
